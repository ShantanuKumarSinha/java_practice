...
public class KthLargestNumber {
  public static void main(String[] args) {
    ...
    var ans = kth.findKthLargest(arr, k);
    System.out.println(ans);
    var ansArray = kth.findKthLargestArray(arr, k);
  ...
  private int[] findKthLargestArray(int[] arr, int k) {
    PriorityQueue<Integer> priorityQueue = new PriorityQueue<>();
    ...
    ans[ans.length - 1] = priorityQueue.peek();
    return ans;
  }
}
