...
*/
public class CommonInteractionPointOfLinkedList {
  public static void main(String[] args) {
    ...
    var resultNode = findCommonNode(head1, head2);
    LinkedListUtilityClass.printValueFromLinkedList(resultNode);
  }
  ...
  private static Node findCommonNode(Node head1, Node head2) {
    ...
    var temp2 = head2;
    while (temp2 != null) {
      if (setNode.add(temp2)) temp2 = temp2.next;
      else return temp2;
    }
    return null;
  }
