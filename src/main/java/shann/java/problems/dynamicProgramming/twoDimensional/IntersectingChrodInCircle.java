...
Explanation 2:
 ...
 So, we return 2.
*/
public class IntersectingChrodInCircle {
  int modulo = 1000000007;

  public static void main(String[] args) {
    IntersectingChrodInCircle intersectingChrodInCircle = new IntersectingChrodInCircle();
    var number1 = intersectingChrodInCircle.chordCnt(4);
    System.out.println(number1);
  }

  public int chordCnt(int input) {
