...
5th argument given is an Array A of size N, denoted by E in input, where A[i] = x co-ordinate of ith circle

6th argument given is an Array B of size N, denoted by F in input, where B[i] = y co-ordinate of ith circle
